...
public class PinkRathian extends Monster {
  ...
  private static final double TAIL_CUTTING = 0.20;
  ...
  private static final double TAIL_TIP_CUTTING = 0.50;
  private static final double TAIL_TIP_BLUNT = 0.45;
  private static final double TAIL_TIP_RANGED = 0.40;
  private static final double TAIL_TIP_FIRE = 0.00;
  private static final double TAIL_TIP_WATER = 0.05;
  private static final double TAIL_TIP_THUNDER = 0.10;
  private static final double TAIL_TIP_ICE = 0.05;
  private static final double TAIL_TIP_DRAGON = 0.20;
  
  public PinkRathian() {
    super(MonsterNames.PINK_RATHIAN, Wyvern.FLYING, MonsterParts.HEAD, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, 
