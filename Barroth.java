...
public class Barroth extends Monster {
  
  private static final double HEAD_CUTTING = 0.22;
  private static final double HEAD_BLUNT = 0.25;
  private static final double HEAD_RANGED = 0.10;
  ...
  private static final double BODY_RANGED = 0.50;
  ...
  private static final double FOREARMS_CUTTING = 0.80;
  private static final double FOREARMS_BLUNT = 0.85;
  private static final double FOREARMS_RANGED = 0.75;
  private static final double FOREARMS_FIRE = 0.30;
  ...
  private static final double LEGS_FIRE = 0.20;
  ...
  private static final double TAIL_FIRE = 0.25;
  ...
  public Barroth() {
    super(MonsterNames.BARROTH, Wyvern.BRUTE, MonsterParts.HEAD, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA,
        MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA,
        MonsterParts.BODY, MonsterParts.NA, MonsterParts.FOREARMS, MonsterParts.LEGS, MonsterParts.TAIL, MonsterParts.NA);
  }
  ...
  public static boolean getWeakness(MonsterParts part) {
    return (part == MonsterParts.FOREARMS || part == MonsterParts.TAIL);
  }
