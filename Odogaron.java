...
public class Odogaron extends Monster {
  
  private static final double HEAD_CUTTING = 0.70;
  private static final double HEAD_BLUNT = 0.75;
  ...
  private static final double HEAD_DRAGON = 0.00;
  ...
  private static final double NECK_DRAGON = 0.00;
  
  private static final double BODY_CUTTING = 0.30;
  private static final double BODY_BLUNT = 0.30;
  private static final double BODY_RANGED = 0.25;
  ...
  private static final double BACK_ICE = 0.15;
  ...
  private static final double FOREARMS_WATER = 0.10;
  private static final double FOREARMS_THUNDER = 0.15;
  private static final double FOREARMS_ICE = 0.25;
  ...
  private static final double LEGS_ICE = 0.25;
  ...
  public Odogaron() {
    super(MonsterNames.ODOGARON, Wyvern.FANGED, MonsterParts.HEAD, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, 
