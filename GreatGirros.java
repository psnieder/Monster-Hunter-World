...
public class GreatGirros extends Monster {
  ...
  private static final double HEAD_WATER = 0.30;
  ...
  private static final double NECK_BLUNT = 0.45;
  private static final double NECK_RANGED = 0.35;
  ...
  private static final double BACK_CUTTING = 0.35;
  private static final double BACK_BLUNT = 0.35;
  private static final double BACK_RANGED = 0.30;
  ...
  private static final double FOREARMS_CUTTING = 0.55;
  private static final double FOREARMS_BLUNT = 0.50;
  private static final double FOREARMS_RANGED = 0.45;
  private static final double FOREARMS_FIRE = 0.10;
  private static final double FOREARMS_WATER = 0.25;
  private static final double FOREARMS_THUNDER = 0.00;
  private static final double FOREARMS_ICE = 0.15;
  ...
  private static final double TAIL_FIRE = 0.05;
  ...
  public GreatGirros() {
    super(MonsterNames.GIRROS, Wyvern.FANGED, MonsterParts.HEAD, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, 
  ...
  public static boolean getWeakness(MonsterParts part) {
    return (part == MonsterParts.HEAD || part == MonsterParts.FOREARMS || part == MonsterParts.TAIL);
  }
