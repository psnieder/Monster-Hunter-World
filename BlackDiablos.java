...
public class BlackDiablos extends Monster {
  
  private static final double HEAD_CUTTING = 0.43;
  private static final double HEAD_BLUNT = 0.55;
  private static final double HEAD_RANGED = 0.30;
  ...
  private static final double HORN_CUTTING = 0.19;
  private static final double HORN_BLUNT = 0.37;
  private static final double HORN_RANGED = 0.15;
  ...
  private static final double HORN_DRAGON = 0.00;
  ...
  private static final double WINGS_DRAGON = 0.00;
  
  private static final double STOMACH_CUTTING = 0.63;
  private static final double STOMACH_BLUNT = 0.68;
  private static final double STOMACH_RANGED = 0.35;
  ...
  private static final double STOMACH_DRAGON = 0.00;
  ...
  private static final double TAIL_TIP_CUTTING = 0.20;
  private static final double TAIL_TIP_BLUNT = 0.24;
  ...
  private static final double TAIL_TIP_DRAGON = 0.00;
  
  public BlackDiablos() {
    super(MonsterNames.BLACK_DIABLOS, Wyvern.FLYING, MonsterParts.HEAD, MonsterParts.HORN, MonsterParts.NA, MonsterParts.NA, 
