...
public class KuluYaKu extends Monster {
  
  private static final double HEAD_CUTTING = 0.85;
  ...
  public KuluYaKu() {
    super(MonsterNames.KULU, Wyvern.BIRD, MonsterParts.HEAD, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA,
        MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA,
        MonsterParts.BODY, MonsterParts.NA, MonsterParts.FOREARMS, MonsterParts.NA, MonsterParts.TAIL, MonsterParts.NA);
  }
