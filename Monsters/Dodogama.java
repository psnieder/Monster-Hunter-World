...
public class Dodogama extends Monster {
  ...
  private static final double NECK_BLUNT = 0.65;
  private static final double NECK_RANGED = 0.55;
  private static final double NECK_FIRE = 0.00;
  private static final double NECK_WATER = 0.10;
  private static final double NECK_THUNDER = 0.25;
  ...
  private static final double BACK_RANGED = 0.40;
  ...
  private static final double BACK_DRAGON = 0.05;
  
  private static final double FOREARMS_CUTTING = 0.45;
  private static final double FOREARMS_BLUNT = 0.45;
  private static final double FOREARMS_RANGED = 0.40;
  private static final double FOREARMS_FIRE = 0.00;
  private static final double FOREARMS_WATER = 0.05;
  private static final double FOREARMS_THUNDER = 0.10;
  ...
  private static final double TAIL_RANGED = 0.50;
  ...
  public Dodogama() {
    super(MonsterNames.DODOGAMA, Wyvern.FANGED, MonsterParts.HEAD, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, 
  ...
  public static boolean getWeakness(MonsterParts part) {
    return (part == MonsterParts.HEAD || part == MonsterParts.NECK || part == MonsterParts.TAIL);
  }
