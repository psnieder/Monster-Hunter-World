...
public class Rathalos extends Monster {
  ...
  private static final double NECK_CUTTING = 0.35;
  ...
  private static final double BODY_CUTTING = 0.25;
  private static final double BODY_BLUNT = 0.25;
  ...
  private static final double BACK_CUTTING = 0.25;
  private static final double BACK_BLUNT = 0.25;
  ...
  public Rathalos() {
    super(MonsterNames.RATHALOS, Wyvern.FLYING, MonsterParts.HEAD, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, 
