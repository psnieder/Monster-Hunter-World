...
public class Uragaan extends Monster {
  ...
  private static final double JAW_CUTTING = 0.19;
  private static final double JAW_BLUNT = 0.20;
  private static final double JAW_RANGED = 0.10;
  private static final double JAW_FIRE = 0.00;
  private static final double JAW_WATER = 0.40;
  private static final double JAW_THUNDER = 0.05;
  private static final double JAW_ICE = 0.20;
  private static final double JAW_DRAGON = 0.30;
  
  private static final double NECK_CUTTING = 0.24;
  private static final double NECK_BLUNT = 0.27;
  private static final double NECK_RANGED = 0.18;
  private static final double NECK_FIRE = 0.00;
  private static final double NECK_WATER = 0.17;
  ...
  private static final double BODY_WATER = 0.30;
  private static final double BODY_THUNDER = 0.05;
  private static final double BODY_ICE = 0.15;
  private static final double BODY_DRAGON = 0.30;
  
  private static final double BACK_CUTTING = 0.22;
  private static final double BACK_BLUNT = 0.24;
  private static final double BACK_RANGED = 0.10;
  ...
  private static final double BACK_DRAGON = 0.15;
  
  private static final double FOREARMS_CUTTING = 0.25;
  private static final double FOREARMS_BLUNT = 0.30;
  private static final double FOREARMS_RANGED = 0.20;
  private static final double FOREARMS_FIRE = 0.00;
  ...
  private static final double LEGS_RANGED = 0.20;
  ...
  public Uragaan() {
    super(MonsterNames.URAGAAN, Wyvern.BRUTE, MonsterParts.HEAD, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, 
        MonsterParts.NA, MonsterParts.JAW, MonsterParts.NECK, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, 
  ...
  public static double getJawCutting() {
    return JAW_CUTTING;
  }

  public static double getJawBlunt() {
    return JAW_BLUNT;
  }

  public static double getJawRanged() {
    return JAW_RANGED;
  }

  public static double getJawFire() {
    return JAW_FIRE;
  }

  public static double getJawWater() {
    return JAW_WATER;
  }

  public static double getJawThunder() {
    return JAW_THUNDER;
  }

  public static double getJawIce() {
    return JAW_ICE;
  }

  public static double getJawDragon() {
    return JAW_DRAGON;
  }
  ...
  public static boolean getWeakness(MonsterParts part) {
    return (part == MonsterParts.HEAD || part == MonsterParts.BODY);
  }
