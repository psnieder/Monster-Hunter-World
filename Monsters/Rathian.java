...
public class Rathian extends Monster {
  ...
  private static final double NECK_ICE = 0.00;
  private static final double NECK_DRAGON = 0.15;
  
  private static final double WINGS_CUTTING = 0.55;
  private static final double WINGS_BLUNT = 0.50;
  ...
  private static final double TAIL_ICE = 0.05;
  private static final double TAIL_DRAGON = 0.20;
  
  public Rathian() {
    super(MonsterNames.RATHIAN, Wyvern.FLYING, MonsterParts.HEAD, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, 
