...
public class GreatJagras extends Monster {
  
  private static final double HEAD_CUTTING = 0.80;
  private static final double HEAD_BLUNT = 0.85;
  private static final double HEAD_RANGED = 0.75;
  private static final double HEAD_FIRE = 0.30;
  ...
  private static final double NECK_CUTTING = 0.65;
  private static final double NECK_BLUNT = 0.70;
  private static final double NECK_RANGED = 0.60;
  ...
  private static final double NECK_ICE = 0.05;
  private static final double NECK_DRAGON = 0.05;
  
  private static final double STOMACH_CUTTING = 0.90;
  private static final double STOMACH_BLUNT = 0.95;
  private static final double STOMACH_RANGED = 0.85;
  private static final double STOMACH_FIRE = 0.30;
  private static final double STOMACH_WATER = 0.00;
  private static final double STOMACH_THUNDER = 0.20;
  private static final double STOMACH_ICE = 0.15;
  private static final double STOMACH_DRAGON = 0.10;
  
  private static final double BODY_CUTTING = 0.50;
  private static final double BODY_BLUNT = 0.45;
  private static final double BODY_RANGED = 0.40;
  private static final double BODY_FIRE = 0.20;
  ...
  private static final double BACK_BLUNT = 0.40;
  private static final double BACK_RANGED = 0.35;
  private static final double BACK_FIRE = 0.15;
  private static final double BACK_WATER = 0.00;
  ...
  private static final double FOREARMS_CUTTING = 0.65;
  private static final double FOREARMS_BLUNT = 0.60;
  private static final double FOREARMS_RANGED = 0.55;
  private static final double FOREARMS_FIRE = 0.25;
  private static final double FOREARMS_WATER = 0.00;
  private static final double FOREARMS_THUNDER = 0.15;
  private static final double FOREARMS_ICE = 0.10;
  private static final double FOREARMS_DRAGON = 0.05;
  
  private static final double LEGS_CUTTING = 0.45;
  private static final double LEGS_BLUNT = 0.40;
  ...
  private static final double LEGS_ICE = 0.00;
  private static final double LEGS_DRAGON = 0.00;
  
  private static final double TAIL_CUTTING = 0.45;
  private static final double TAIL_BLUNT = 0.45;
  private static final double TAIL_RANGED = 0.40;
  ...
  private static final double TAIL_ICE = 0.00;
  private static final double TAIL_DRAGON = 0.00;
  
  public GreatJagras() {
    super(MonsterNames.JAGRAS, Wyvern.FANGED, MonsterParts.HEAD, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, 
        MonsterParts.NA, MonsterParts.NA, MonsterParts.NECK, MonsterParts.NA, MonsterParts.NA, MonsterParts.NA, 
        MonsterParts.STOMACH, MonsterParts.NA, MonsterParts.BODY, MonsterParts.BACK, MonsterParts.FOREARMS, MonsterParts.LEGS, 
  ...
  public static boolean getWeakness(MonsterParts part) {
    return (part == MonsterParts.HEAD || part == MonsterParts.NECK || part == MonsterParts.BODY 
        || part == MonsterParts.STOMACH || part == MonsterParts.FOREARMS);
  }
